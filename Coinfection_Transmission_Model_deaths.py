...
def funct(y,t):
    ...
    ####### Infected Class
    f4 = k1*E1 - d1*I1 - df*I1
    f5 = k2*E2 - d2*I2 - dc*I2 - b1*I2*(I1*I3+RI2)
    f6 = k1*E3 - d3*I3
    ...
    f12 =k1*RL2 -d1*RI2
    ############ Recovered Class
    f13 =d2*RI1+d1*RI2+d3*I3 + df*I1 + dc*I2 
